            ...
            <div class="p-6">
                <form id="uploadForm" @submit.prevent="uploadCareer()">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" x-model="formData.description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded" required></textarea>
                    </div>
                    <div class="mb-4">
            ...
            <div class="p-6">
                <form id="editForm" @submit.prevent="updateCareer()">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="edit_description" x-model="formData.description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded" required></textarea>
                    </div>
                    <div class="mb-4">
